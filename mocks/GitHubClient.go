...
// NewGitHubClient creates a new instance of GitHubClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGitHubClient(t testing.TB) *GitHubClient {
	mock := &GitHubClient{}
	mock.Mock.Test(t)
